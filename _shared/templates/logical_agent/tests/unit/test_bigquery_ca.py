...
def _make_args(**overrides):
    defaults = {
        ...
        "job_labels": {"domain": "__DOMAIN__", "logical_agent": "__LOGICAL_AGENT__"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "__LOGICAL_AGENT__"

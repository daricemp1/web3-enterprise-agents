...
| No. | Agent | Gemini Enterprise Display Name | Focus |
| :--- | :--- | :--- | :--- |
| 1 | [`cart_checkout_analytics`](domains/e_commerce/agents/cart_checkout_analytics/README.md) ([🎬 Demo](https://raw.githubusercontent.com/rajanm/retail-enterprise-agents/master/demos/gemini-enterprise/e_commerce/cart_checkout_analytics.mp4)) | E-Commerce: Cart & Checkout Analytics | Digital funnel conversion rates, checkout stage cart abandonment %, payment gateway decline rates, promo validation errors |

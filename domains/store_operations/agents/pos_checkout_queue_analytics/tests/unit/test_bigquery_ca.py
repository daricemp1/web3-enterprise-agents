...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "pos_checkout_queue_analytics",
        "job_labels": {"domain": "store_operations", "logical_agent": "pos_checkout_queue_analytics"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "pos_checkout_queue_analytics"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "pos_checkout_queue_analytics",
    }

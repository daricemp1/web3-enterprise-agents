...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_cash_management_tills",
        "job_labels": {"domain": "store_operations", "logical_agent": "store_cash_management_tills"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_cash_management_tills"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "store_cash_management_tills",
    }

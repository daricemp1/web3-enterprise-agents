...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "energy_facilities_maintenance",
        "job_labels": {"domain": "store_operations", "logical_agent": "energy_facilities_maintenance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "energy_facilities_maintenance"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "energy_facilities_maintenance",
    }

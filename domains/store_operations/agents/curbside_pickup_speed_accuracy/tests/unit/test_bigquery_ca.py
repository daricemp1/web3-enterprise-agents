...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "curbside_pickup_speed_accuracy",
        "job_labels": {"domain": "store_operations", "logical_agent": "curbside_pickup_speed_accuracy"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "curbside_pickup_speed_accuracy"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "curbside_pickup_speed_accuracy",
    }

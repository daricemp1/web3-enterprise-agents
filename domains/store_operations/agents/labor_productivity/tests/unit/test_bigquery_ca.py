...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "labor_productivity",
        "job_labels": {"domain": "store_operations", "logical_agent": "labor_productivity"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "labor_productivity"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "labor_productivity",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_fulfillment_execution",
        "job_labels": {"domain": "store_operations", "logical_agent": "store_fulfillment_execution"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_fulfillment_execution"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "store_fulfillment_execution",
    }

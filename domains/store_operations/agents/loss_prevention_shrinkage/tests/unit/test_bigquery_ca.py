...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "loss_prevention_shrinkage",
        "job_labels": {"domain": "store_operations", "logical_agent": "loss_prevention_shrinkage"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "loss_prevention_shrinkage"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "loss_prevention_shrinkage",
    }

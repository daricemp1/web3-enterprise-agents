...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "omnichannel_returns_in_store",
        "job_labels": {"domain": "store_operations", "logical_agent": "omnichannel_returns_in_store"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "omnichannel_returns_in_store"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "omnichannel_returns_in_store",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "visual_merchandising_compliance",
        "job_labels": {"domain": "store_operations", "logical_agent": "visual_merchandising_compliance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "visual_merchandising_compliance"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "visual_merchandising_compliance",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_manager_operational_audit",
        "job_labels": {"domain": "store_operations", "logical_agent": "store_manager_operational_audit"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_manager_operational_audit"
    assert tool_config.job_labels == {
        "domain": "store_operations",
        "logical_agent": "store_manager_operational_audit",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "workplace_safety_workers_comp",
        "job_labels": {"domain": "human_resources", "logical_agent": "workplace_safety_workers_comp"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "workplace_safety_workers_comp"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "workplace_safety_workers_comp",
    }

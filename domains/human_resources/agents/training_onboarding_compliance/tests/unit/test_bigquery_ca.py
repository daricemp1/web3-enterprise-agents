...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "training_onboarding_compliance",
        "job_labels": {"domain": "human_resources", "logical_agent": "training_onboarding_compliance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "training_onboarding_compliance"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "training_onboarding_compliance",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "labor_union_compliance_cba",
        "job_labels": {"domain": "human_resources", "logical_agent": "labor_union_compliance_cba"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "labor_union_compliance_cba"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "labor_union_compliance_cba",
    }

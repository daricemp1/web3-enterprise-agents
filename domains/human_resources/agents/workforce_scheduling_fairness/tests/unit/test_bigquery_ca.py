...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "workforce_scheduling_fairness",
        "job_labels": {"domain": "human_resources", "logical_agent": "workforce_scheduling_fairness"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "workforce_scheduling_fairness"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "workforce_scheduling_fairness",
    }

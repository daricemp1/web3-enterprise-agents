...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "seasonal_hiring_peak_readiness",
        "job_labels": {"domain": "human_resources", "logical_agent": "seasonal_hiring_peak_readiness"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "seasonal_hiring_peak_readiness"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "seasonal_hiring_peak_readiness",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_associate_turnover_retention",
        "job_labels": {"domain": "human_resources", "logical_agent": "store_associate_turnover_retention"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_associate_turnover_retention"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "store_associate_turnover_retention",
    }

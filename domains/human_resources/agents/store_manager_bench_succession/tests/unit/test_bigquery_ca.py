...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_manager_bench_succession",
        "job_labels": {"domain": "human_resources", "logical_agent": "store_manager_bench_succession"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_manager_bench_succession"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "store_manager_bench_succession",
    }

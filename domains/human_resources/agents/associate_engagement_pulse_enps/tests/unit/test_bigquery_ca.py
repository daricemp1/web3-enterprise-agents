...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "associate_engagement_pulse_enps",
        "job_labels": {"domain": "human_resources", "logical_agent": "associate_engagement_pulse_enps"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "associate_engagement_pulse_enps"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "associate_engagement_pulse_enps",
    }

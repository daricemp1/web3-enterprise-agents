...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "frontline_wage_market_benchmarks",
        "job_labels": {"domain": "human_resources", "logical_agent": "frontline_wage_market_benchmarks"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "frontline_wage_market_benchmarks"
    assert tool_config.job_labels == {
        "domain": "human_resources",
        "logical_agent": "frontline_wage_market_benchmarks",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "marketplace_seller_performance",
        "job_labels": {"domain": "e_commerce", "logical_agent": "marketplace_seller_performance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "marketplace_seller_performance"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "marketplace_seller_performance",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "mobile_app_conversion_retention",
        "job_labels": {"domain": "e_commerce", "logical_agent": "mobile_app_conversion_retention"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "mobile_app_conversion_retention"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "mobile_app_conversion_retention",
    }

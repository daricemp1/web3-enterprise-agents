...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "search_merchandising_personalization",
        "job_labels": {"domain": "e_commerce", "logical_agent": "search_merchandising_personalization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "search_merchandising_personalization"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "search_merchandising_personalization",
    }

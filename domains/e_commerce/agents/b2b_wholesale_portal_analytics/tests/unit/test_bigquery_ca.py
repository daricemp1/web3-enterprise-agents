...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "b2b_wholesale_portal_analytics",
        "job_labels": {"domain": "e_commerce", "logical_agent": "b2b_wholesale_portal_analytics"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "b2b_wholesale_portal_analytics"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "b2b_wholesale_portal_analytics",
    }

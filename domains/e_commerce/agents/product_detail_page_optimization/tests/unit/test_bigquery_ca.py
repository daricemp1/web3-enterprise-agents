...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "product_detail_page_optimization",
        "job_labels": {"domain": "e_commerce", "logical_agent": "product_detail_page_optimization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "product_detail_page_optimization"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "product_detail_page_optimization",
    }

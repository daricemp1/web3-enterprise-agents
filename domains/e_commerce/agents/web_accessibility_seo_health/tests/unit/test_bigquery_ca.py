...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "web_accessibility_seo_health",
        "job_labels": {"domain": "e_commerce", "logical_agent": "web_accessibility_seo_health"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "web_accessibility_seo_health"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "web_accessibility_seo_health",
    }

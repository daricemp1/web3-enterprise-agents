...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "subscription_recurring_orders",
        "job_labels": {"domain": "e_commerce", "logical_agent": "subscription_recurring_orders"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "subscription_recurring_orders"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "subscription_recurring_orders",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "payment_gateway_fraud_risk",
        "job_labels": {"domain": "e_commerce", "logical_agent": "payment_gateway_fraud_risk"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "payment_gateway_fraud_risk"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "payment_gateway_fraud_risk",
    }

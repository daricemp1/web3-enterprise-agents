...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "digital_promotions_coupon_abuse",
        "job_labels": {"domain": "e_commerce", "logical_agent": "digital_promotions_coupon_abuse"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "digital_promotions_coupon_abuse"
    assert tool_config.job_labels == {
        "domain": "e_commerce",
        "logical_agent": "digital_promotions_coupon_abuse",
    }

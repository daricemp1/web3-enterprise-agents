...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "water_conservation_facility_audit",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "water_conservation_facility_audit"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "water_conservation_facility_audit"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "water_conservation_facility_audit",
    }

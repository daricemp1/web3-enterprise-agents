...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "chemical_restricted_substances_rsl",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "chemical_restricted_substances_rsl"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "chemical_restricted_substances_rsl"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "chemical_restricted_substances_rsl",
    }

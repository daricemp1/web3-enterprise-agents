...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "dei_supplier_diversity_spend",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "dei_supplier_diversity_spend"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "dei_supplier_diversity_spend"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "dei_supplier_diversity_spend",
    }

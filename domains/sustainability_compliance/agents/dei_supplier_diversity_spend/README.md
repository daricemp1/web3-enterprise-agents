...
> - [🎬 Interactive Demo Player](https://rajanm.github.io/retail-enterprise-agents/demos/gemini-enterprise/sustainability_compliance/dei_supplier_diversity_spend.html)
> - [⬇️ Direct Video File (.mp4)](https://rajanm.github.io/retail-enterprise-agents/demos/gemini-enterprise/sustainability_compliance/dei_supplier_diversity_spend.mp4)

```mermaid
sequenceDiagram
    autonumber
    actor User as Retail ESG Executive
    participant Agent as ESG: Supplier Diversity & Equity Spend
    participant Canvas as Gemini Enterprise Canvas

    Note over User,Agent: Turn 1: Quantitative Data Insights (BigQuery)
    User->>Agent: Prompt 1: Diverse supplier spend shares % (MBE, WBE, VBE, LGBTBE) of total corporate procurement and incubator brand graduation counts
    ...
    User->>Agent: Prompt 2: National Minority Supplier Development Council (NMSDC) benchmarks, corporate diversity procurement best practices, and Tier-2 supplier reporting
    ...
    User->>Agent: Prompt 4: 4-slide executive presentation summarizing the Supplier Diversity & Equity Spend analysis, key KPIs, and strategic recommendations

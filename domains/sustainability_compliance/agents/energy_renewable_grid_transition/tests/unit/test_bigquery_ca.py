...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "energy_renewable_grid_transition",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "energy_renewable_grid_transition"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "energy_renewable_grid_transition"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "energy_renewable_grid_transition",
    }

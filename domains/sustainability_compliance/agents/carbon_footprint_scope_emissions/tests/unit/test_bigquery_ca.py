...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "carbon_footprint_scope_emissions",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "carbon_footprint_scope_emissions"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "carbon_footprint_scope_emissions"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "carbon_footprint_scope_emissions",
    }

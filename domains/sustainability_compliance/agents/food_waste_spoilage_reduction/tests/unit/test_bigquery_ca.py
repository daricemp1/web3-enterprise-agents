...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "food_waste_spoilage_reduction",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "food_waste_spoilage_reduction"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "food_waste_spoilage_reduction"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "food_waste_spoilage_reduction",
    }

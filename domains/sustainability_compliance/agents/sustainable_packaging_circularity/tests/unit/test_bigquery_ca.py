...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "sustainable_packaging_circularity",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "sustainable_packaging_circularity"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "sustainable_packaging_circularity"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "sustainable_packaging_circularity",
    }

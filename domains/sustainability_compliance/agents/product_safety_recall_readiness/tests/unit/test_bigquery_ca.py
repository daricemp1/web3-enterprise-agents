...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "product_safety_recall_readiness",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "product_safety_recall_readiness"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "product_safety_recall_readiness"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "product_safety_recall_readiness",
    }

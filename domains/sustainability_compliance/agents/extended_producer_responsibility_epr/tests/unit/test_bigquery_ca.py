...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "extended_producer_responsibility_epr",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "extended_producer_responsibility_epr"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "extended_producer_responsibility_epr"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "extended_producer_responsibility_epr",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "ethical_sourcing_labor_audits",
        "job_labels": {"domain": "sustainability_compliance", "logical_agent": "ethical_sourcing_labor_audits"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "ethical_sourcing_labor_audits"
    assert tool_config.job_labels == {
        "domain": "sustainability_compliance",
        "logical_agent": "ethical_sourcing_labor_audits",
    }

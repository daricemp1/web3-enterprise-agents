...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "gift_card_breakage_liability",
        "job_labels": {"domain": "finance", "logical_agent": "gift_card_breakage_liability"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "gift_card_breakage_liability"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "gift_card_breakage_liability",
    }

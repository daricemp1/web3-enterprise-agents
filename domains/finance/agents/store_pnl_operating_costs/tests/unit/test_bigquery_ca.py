...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_pnl_operating_costs",
        "job_labels": {"domain": "finance", "logical_agent": "store_pnl_operating_costs"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_pnl_operating_costs"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "store_pnl_operating_costs",
    }

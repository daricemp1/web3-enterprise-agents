...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "foreign_exchange_landed_costs",
        "job_labels": {"domain": "finance", "logical_agent": "foreign_exchange_landed_costs"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "foreign_exchange_landed_costs"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "foreign_exchange_landed_costs",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "sales_tax_nexus_compliance",
        "job_labels": {"domain": "finance", "logical_agent": "sales_tax_nexus_compliance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "sales_tax_nexus_compliance"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "sales_tax_nexus_compliance",
    }

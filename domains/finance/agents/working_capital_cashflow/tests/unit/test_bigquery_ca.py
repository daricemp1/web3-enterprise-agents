...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "working_capital_cashflow",
        "job_labels": {"domain": "finance", "logical_agent": "working_capital_cashflow"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "working_capital_cashflow"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "working_capital_cashflow",
    }

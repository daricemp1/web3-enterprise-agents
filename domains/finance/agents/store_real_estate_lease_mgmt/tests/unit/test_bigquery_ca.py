...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_real_estate_lease_mgmt",
        "job_labels": {"domain": "finance", "logical_agent": "store_real_estate_lease_mgmt"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_real_estate_lease_mgmt"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "store_real_estate_lease_mgmt",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "corporate_budget_variance_fpna",
        "job_labels": {"domain": "finance", "logical_agent": "corporate_budget_variance_fpna"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "corporate_budget_variance_fpna"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "corporate_budget_variance_fpna",
    }

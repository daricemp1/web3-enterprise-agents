...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "inventory_valuation_provisions",
        "job_labels": {"domain": "finance", "logical_agent": "inventory_valuation_provisions"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "inventory_valuation_provisions"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "inventory_valuation_provisions",
    }

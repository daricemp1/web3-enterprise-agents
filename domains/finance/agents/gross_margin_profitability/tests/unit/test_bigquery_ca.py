...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "gross_margin_profitability",
        "job_labels": {"domain": "finance", "logical_agent": "gross_margin_profitability"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "gross_margin_profitability"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "gross_margin_profitability",
    }

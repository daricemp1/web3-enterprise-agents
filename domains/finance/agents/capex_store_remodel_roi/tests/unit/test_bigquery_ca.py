...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "capex_store_remodel_roi",
        "job_labels": {"domain": "finance", "logical_agent": "capex_store_remodel_roi"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "capex_store_remodel_roi"
    assert tool_config.job_labels == {
        "domain": "finance",
        "logical_agent": "capex_store_remodel_roi",
    }

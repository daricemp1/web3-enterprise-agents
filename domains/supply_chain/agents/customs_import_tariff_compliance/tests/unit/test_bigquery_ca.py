...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "customs_import_tariff_compliance",
        "job_labels": {"domain": "supply_chain", "logical_agent": "customs_import_tariff_compliance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "customs_import_tariff_compliance"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "customs_import_tariff_compliance",
    }

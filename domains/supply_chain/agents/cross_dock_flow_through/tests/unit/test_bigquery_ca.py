...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "cross_dock_flow_through",
        "job_labels": {"domain": "supply_chain", "logical_agent": "cross_dock_flow_through"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "cross_dock_flow_through"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "cross_dock_flow_through",
    }

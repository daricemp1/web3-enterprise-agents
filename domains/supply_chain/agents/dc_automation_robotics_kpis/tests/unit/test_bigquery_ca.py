...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "dc_automation_robotics_kpis",
        "job_labels": {"domain": "supply_chain", "logical_agent": "dc_automation_robotics_kpis"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "dc_automation_robotics_kpis"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "dc_automation_robotics_kpis",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "inbound_freight_optimization",
        "job_labels": {"domain": "supply_chain", "logical_agent": "inbound_freight_optimization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "inbound_freight_optimization"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "inbound_freight_optimization",
    }

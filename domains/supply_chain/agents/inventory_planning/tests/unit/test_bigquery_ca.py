...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "inventory_planning",
        "job_labels": {"domain": "supply_chain", "logical_agent": "inventory_planning"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "inventory_planning"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "inventory_planning",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "vendor_performance",
        "job_labels": {"domain": "supply_chain", "logical_agent": "vendor_performance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "vendor_performance"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "vendor_performance",
    }

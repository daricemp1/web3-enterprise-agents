...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "multi_echelon_safety_stock",
        "job_labels": {"domain": "supply_chain", "logical_agent": "multi_echelon_safety_stock"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "multi_echelon_safety_stock"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "multi_echelon_safety_stock",
    }

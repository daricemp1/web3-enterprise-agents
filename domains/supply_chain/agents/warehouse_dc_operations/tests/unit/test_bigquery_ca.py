...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "warehouse_dc_operations",
        "job_labels": {"domain": "supply_chain", "logical_agent": "warehouse_dc_operations"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "warehouse_dc_operations"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "warehouse_dc_operations",
    }

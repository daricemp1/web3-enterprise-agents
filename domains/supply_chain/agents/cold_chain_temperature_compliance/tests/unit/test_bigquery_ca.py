...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "cold_chain_temperature_compliance",
        "job_labels": {"domain": "supply_chain", "logical_agent": "cold_chain_temperature_compliance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "cold_chain_temperature_compliance"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "cold_chain_temperature_compliance",
    }

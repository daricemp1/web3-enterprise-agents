...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "last_mile_delivery_dispatch",
        "job_labels": {"domain": "supply_chain", "logical_agent": "last_mile_delivery_dispatch"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "last_mile_delivery_dispatch"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "last_mile_delivery_dispatch",
    }

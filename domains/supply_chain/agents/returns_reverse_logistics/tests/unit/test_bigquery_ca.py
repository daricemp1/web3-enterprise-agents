...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "returns_reverse_logistics",
        "job_labels": {"domain": "supply_chain", "logical_agent": "returns_reverse_logistics"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "returns_reverse_logistics"
    assert tool_config.job_labels == {
        "domain": "supply_chain",
        "logical_agent": "returns_reverse_logistics",
    }

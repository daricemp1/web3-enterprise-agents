...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "size_pack_optimization",
        "job_labels": {"domain": "merchandising", "logical_agent": "size_pack_optimization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "size_pack_optimization"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "size_pack_optimization",
    }

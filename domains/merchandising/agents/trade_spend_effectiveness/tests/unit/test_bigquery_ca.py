...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "trade_spend_effectiveness",
        "job_labels": {"domain": "merchandising", "logical_agent": "trade_spend_effectiveness"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "trade_spend_effectiveness"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "trade_spend_effectiveness",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "item_lifecycle_rationalization",
        "job_labels": {"domain": "merchandising", "logical_agent": "item_lifecycle_rationalization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "item_lifecycle_rationalization"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "item_lifecycle_rationalization",
    }

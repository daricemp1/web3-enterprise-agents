...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "localized_curation_clustering",
        "job_labels": {"domain": "merchandising", "logical_agent": "localized_curation_clustering"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "localized_curation_clustering"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "localized_curation_clustering",
    }

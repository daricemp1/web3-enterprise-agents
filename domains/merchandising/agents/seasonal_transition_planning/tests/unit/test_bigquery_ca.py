...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "seasonal_transition_planning",
        "job_labels": {"domain": "merchandising", "logical_agent": "seasonal_transition_planning"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "seasonal_transition_planning"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "seasonal_transition_planning",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "space_planning_micro_merch",
        "job_labels": {"domain": "merchandising", "logical_agent": "space_planning_micro_merch"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "space_planning_micro_merch"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "space_planning_micro_merch",
    }

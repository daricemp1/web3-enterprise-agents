...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "vendor_negotiation_rebates",
        "job_labels": {"domain": "merchandising", "logical_agent": "vendor_negotiation_rebates"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "vendor_negotiation_rebates"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "vendor_negotiation_rebates",
    }

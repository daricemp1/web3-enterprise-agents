...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "price_matching_competitor_intel",
        "job_labels": {"domain": "merchandising", "logical_agent": "price_matching_competitor_intel"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "price_matching_competitor_intel"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "price_matching_competitor_intel",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "private_brand_development",
        "job_labels": {"domain": "merchandising", "logical_agent": "private_brand_development"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "private_brand_development"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "private_brand_development",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "sell_through_inventory_health",
        "job_labels": {"domain": "merchandising", "logical_agent": "sell_through_inventory_health"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "sell_through_inventory_health"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "sell_through_inventory_health",
    }

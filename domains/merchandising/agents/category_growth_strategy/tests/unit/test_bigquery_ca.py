...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "category_growth_strategy",
        "job_labels": {"domain": "merchandising", "logical_agent": "category_growth_strategy"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "category_growth_strategy"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "category_growth_strategy",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "markdown_clearance_optimization",
        "job_labels": {"domain": "merchandising", "logical_agent": "markdown_clearance_optimization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "markdown_clearance_optimization"
    assert tool_config.job_labels == {
        "domain": "merchandising",
        "logical_agent": "markdown_clearance_optimization",
    }

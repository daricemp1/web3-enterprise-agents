...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "damaged_goods_claims_resolution",
        "job_labels": {"domain": "customer_care", "logical_agent": "damaged_goods_claims_resolution"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "damaged_goods_claims_resolution"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "damaged_goods_claims_resolution",
    }

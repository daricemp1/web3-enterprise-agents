...
Watch the deployed **Customer Care: Social Support & Public Sentiment** execute a live multi-turn analytical reasoning session in Gemini Enterprise:

> 📺 **Interactive Demo Player**: [Open Full HD Video Player (1080p)](../../../../demos/gemini-enterprise/customer_care/omnichannel_social_support_desk.html)  
> 📹 **Direct MP4 Download**: [`omnichannel_social_support_desk.mp4`](../../../../demos/gemini-enterprise/customer_care/omnichannel_social_support_desk.mp4)

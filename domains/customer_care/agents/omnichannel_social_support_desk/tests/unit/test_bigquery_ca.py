...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "omnichannel_social_support_desk",
        "job_labels": {"domain": "customer_care", "logical_agent": "omnichannel_social_support_desk"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "omnichannel_social_support_desk"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "omnichannel_social_support_desk",
    }

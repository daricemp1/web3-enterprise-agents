...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "contact_center_agent_performance",
        "job_labels": {"domain": "customer_care", "logical_agent": "contact_center_agent_performance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "contact_center_agent_performance"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "contact_center_agent_performance",
    }

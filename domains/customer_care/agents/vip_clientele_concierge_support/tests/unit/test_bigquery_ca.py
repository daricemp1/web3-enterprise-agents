...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "vip_clientele_concierge_support",
        "job_labels": {"domain": "customer_care", "logical_agent": "vip_clientele_concierge_support"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "vip_clientele_concierge_support"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "vip_clientele_concierge_support",
    }

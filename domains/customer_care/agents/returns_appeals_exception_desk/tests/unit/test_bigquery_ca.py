...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "returns_appeals_exception_desk",
        "job_labels": {"domain": "customer_care", "logical_agent": "returns_appeals_exception_desk"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "returns_appeals_exception_desk"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "returns_appeals_exception_desk",
    }

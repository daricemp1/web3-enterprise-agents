...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "wismo_order_tracking_resolution",
        "job_labels": {"domain": "customer_care", "logical_agent": "wismo_order_tracking_resolution"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "wismo_order_tracking_resolution"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "wismo_order_tracking_resolution",
    }

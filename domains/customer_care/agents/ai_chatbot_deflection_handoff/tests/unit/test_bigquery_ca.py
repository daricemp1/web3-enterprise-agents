...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "ai_chatbot_deflection_handoff",
        "job_labels": {"domain": "customer_care", "logical_agent": "ai_chatbot_deflection_handoff"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "ai_chatbot_deflection_handoff"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "ai_chatbot_deflection_handoff",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "voice_of_customer_sentiment_nlp",
        "job_labels": {"domain": "customer_care", "logical_agent": "voice_of_customer_sentiment_nlp"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "voice_of_customer_sentiment_nlp"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "voice_of_customer_sentiment_nlp",
    }

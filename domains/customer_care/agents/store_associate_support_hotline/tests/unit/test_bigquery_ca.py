...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "store_associate_support_hotline",
        "job_labels": {"domain": "customer_care", "logical_agent": "store_associate_support_hotline"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "store_associate_support_hotline"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "store_associate_support_hotline",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "product_warranty_claims_repair",
        "job_labels": {"domain": "customer_care", "logical_agent": "product_warranty_claims_repair"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "product_warranty_claims_repair"
    assert tool_config.job_labels == {
        "domain": "customer_care",
        "logical_agent": "product_warranty_claims_repair",
    }

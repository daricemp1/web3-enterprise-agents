...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "yield_staking_optimizer",
        "job_labels": {"domain": "defi", "logical_agent": "yield_staking_optimizer"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "yield_staking_optimizer"
    assert tool_config.job_labels == {
        "domain": "defi",
        "logical_agent": "yield_staking_optimizer",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "lending_liquidation_risk",
        "job_labels": {"domain": "defi", "logical_agent": "lending_liquidation_risk"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "lending_liquidation_risk"
    assert tool_config.job_labels == {
        "domain": "defi",
        "logical_agent": "lending_liquidation_risk",
    }

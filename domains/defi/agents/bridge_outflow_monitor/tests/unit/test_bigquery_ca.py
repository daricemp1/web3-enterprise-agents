...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "bridge_outflow_monitor",
        "job_labels": {"domain": "defi", "logical_agent": "bridge_outflow_monitor"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "bridge_outflow_monitor"
    assert tool_config.job_labels == {
        "domain": "defi",
        "logical_agent": "bridge_outflow_monitor",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "dex_amm_liquidity",
        "job_labels": {"domain": "defi", "logical_agent": "dex_amm_liquidity"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "dex_amm_liquidity"
    assert tool_config.job_labels == {
        "domain": "defi",
        "logical_agent": "dex_amm_liquidity",
    }

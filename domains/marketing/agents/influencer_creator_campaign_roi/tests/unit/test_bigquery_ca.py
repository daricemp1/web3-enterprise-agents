...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "influencer_creator_campaign_roi",
        "job_labels": {"domain": "marketing", "logical_agent": "influencer_creator_campaign_roi"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "influencer_creator_campaign_roi"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "influencer_creator_campaign_roi",
    }

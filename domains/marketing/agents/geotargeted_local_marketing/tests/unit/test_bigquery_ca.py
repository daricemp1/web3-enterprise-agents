...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "geotargeted_local_marketing",
        "job_labels": {"domain": "marketing", "logical_agent": "geotargeted_local_marketing"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "geotargeted_local_marketing"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "geotargeted_local_marketing",
    }

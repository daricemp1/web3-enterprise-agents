...
**Domain:** marketing · **Gemini Enterprise display name:** **TODO(scaffold):** e.g. `<domain display_name>: Marketing: CRM, Email & SMS Campaign Orchestration` — look up the domain's `display_name` in `_shared/table_registry.yaml`.

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "email_sms_crm_orchestration",
        "job_labels": {"domain": "marketing", "logical_agent": "email_sms_crm_orchestration"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "email_sms_crm_orchestration"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "email_sms_crm_orchestration",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "retail_media_network_monetization",
        "job_labels": {"domain": "marketing", "logical_agent": "retail_media_network_monetization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "retail_media_network_monetization"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "retail_media_network_monetization",
    }

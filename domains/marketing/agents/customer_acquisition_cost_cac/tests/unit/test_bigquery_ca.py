...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "customer_acquisition_cost_cac",
        "job_labels": {"domain": "marketing", "logical_agent": "customer_acquisition_cost_cac"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "customer_acquisition_cost_cac"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "customer_acquisition_cost_cac",
    }

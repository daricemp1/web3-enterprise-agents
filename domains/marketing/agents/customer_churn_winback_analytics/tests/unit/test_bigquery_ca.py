...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "customer_churn_winback_analytics",
        "job_labels": {"domain": "marketing", "logical_agent": "customer_churn_winback_analytics"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "customer_churn_winback_analytics"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "customer_churn_winback_analytics",
    }

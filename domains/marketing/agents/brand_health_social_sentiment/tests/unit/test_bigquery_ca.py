...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "brand_health_social_sentiment",
        "job_labels": {"domain": "marketing", "logical_agent": "brand_health_social_sentiment"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "brand_health_social_sentiment"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "brand_health_social_sentiment",
    }

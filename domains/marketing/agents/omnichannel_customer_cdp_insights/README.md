...
**Domain:** marketing · **Gemini Enterprise display name:** **TODO(scaffold):** e.g. `<domain display_name>: Marketing: Omnichannel CDP & Customer Identity` — look up the domain's `display_name` in `_shared/table_registry.yaml`.

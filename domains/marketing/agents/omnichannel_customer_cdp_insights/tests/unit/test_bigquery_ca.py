...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "omnichannel_customer_cdp_insights",
        "job_labels": {"domain": "marketing", "logical_agent": "omnichannel_customer_cdp_insights"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "omnichannel_customer_cdp_insights"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "omnichannel_customer_cdp_insights",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "customer_lifecycle_loyalty",
        "job_labels": {"domain": "marketing", "logical_agent": "customer_lifecycle_loyalty"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "customer_lifecycle_loyalty"
    assert tool_config.job_labels == {
        "domain": "marketing",
        "logical_agent": "customer_lifecycle_loyalty",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "validator_rpc_health",
        "job_labels": {"domain": "infra", "logical_agent": "validator_rpc_health"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "validator_rpc_health"
    assert tool_config.job_labels == {
        "domain": "infra",
        "logical_agent": "validator_rpc_health",
    }

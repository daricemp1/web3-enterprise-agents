...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "mev_arbitrage_radar",
        "job_labels": {"domain": "infra", "logical_agent": "mev_arbitrage_radar"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "mev_arbitrage_radar"
    assert tool_config.job_labels == {
        "domain": "infra",
        "logical_agent": "mev_arbitrage_radar",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "l2_sequencer_throughput",
        "job_labels": {"domain": "infra", "logical_agent": "l2_sequencer_throughput"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "l2_sequencer_throughput"
    assert tool_config.job_labels == {
        "domain": "infra",
        "logical_agent": "l2_sequencer_throughput",
    }

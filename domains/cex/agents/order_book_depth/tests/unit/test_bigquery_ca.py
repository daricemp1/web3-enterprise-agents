...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "order_book_depth",
        "job_labels": {"domain": "cex", "logical_agent": "order_book_depth"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "order_book_depth"
    assert tool_config.job_labels == {
        "domain": "cex",
        "logical_agent": "order_book_depth",
    }

...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "proof_of_reserves",
        "job_labels": {"domain": "cex", "logical_agent": "proof_of_reserves"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "proof_of_reserves"
    assert tool_config.job_labels == {
        "domain": "cex",
        "logical_agent": "proof_of_reserves",
    }

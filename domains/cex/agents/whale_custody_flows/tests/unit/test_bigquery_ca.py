...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "whale_custody_flows",
        "job_labels": {"domain": "cex", "logical_agent": "whale_custody_flows"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "whale_custody_flows"
    assert tool_config.job_labels == {
        "domain": "cex",
        "logical_agent": "whale_custody_flows",
    }
